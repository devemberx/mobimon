...
if [ ! -f .githooks/commit-msg ] || [ ! -f .gitmessage ]; then
    printf 'setup-hooks: Both .githooks/commit-msg and .gitmessage are required.\n' >&2
    exit 1
fi
...
printf 'Installed the commit message hook and template for this repository.\n'
