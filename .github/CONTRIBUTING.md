...
CI runs these tests on an API 34 Google APIs emulator in parallel with local
checks. Both jobs must pass through `Android checks`; this does not verify AAOS
or Release behavior.
