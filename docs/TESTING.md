...
| P02 drawer stays within its window with 76dp targets, takes initial focus, dismisses on backdrop/close/Back, routes to the six menu destinations, and updates the portrait/name when the equipped friend changes; destination Back restores Home; AAOS restrictions preserve the route and remove Debug controls from composition | [MobiMonContentTest](../app/src/test/java/com/monsters/mobimon/ui/MobiMonContentTest.kt), [ShellStateTest](../app/src/test/java/com/monsters/mobimon/ui/ShellStateTest.kt) | Compose and JVM |
