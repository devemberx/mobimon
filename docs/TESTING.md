...
| Home preserves point loading/failure and truthful parking when vehicle data is lost or recovered; it omits the tagline Simulation badge, battery, Vehicle/Quest artwork shortcuts and vehicle-home preview controls, and conversation stays disabled without a connection destination | [PetHomeScreenTest](../feature/feature-pet/src/test/java/com/monsters/mobimon/feature/pet/PetHomeScreenTest.kt) | Compose and Robolectric |
