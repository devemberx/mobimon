...
| Parking badge requires complete valid Park evidence; all routes share copy, icon-free centered text, fixed size, muted orange restricted style and top-right geometry while the badge moves with its route | `ParkingBadgeStatusTest`, `MobiMonParkingBadgeTest`, and owning Home, Settings, Vehicle, Quest, Store, Connection and Conversation screen suites |
