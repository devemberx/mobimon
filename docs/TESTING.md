...
| Authentication input/lifecycle guards, readiness separation, QR decoding and UI states | [Authentication feature suites](../feature/feature-auth/src/test/java/com/monsters/mobimon/feature/auth); ViewModel and Robolectric |
