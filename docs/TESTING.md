...
| Chat draft/composition lifetime, ownership clearing, input guards/actions, badge/avatar/composer geometry, inline failure and navigation/IME resizing | [Conversation and feature suites](../feature/feature-auth/src/test/java/com/monsters/mobimon/feature/auth); native review images |
