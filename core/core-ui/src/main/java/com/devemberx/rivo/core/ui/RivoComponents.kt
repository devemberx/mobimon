package com.devemberx.rivo.core.ui
...
fun RivoSourceBadge(
    ...
    Surface(
        ...
        Text(
            text = stringResource(if (simulated) R.string.rivo_source_simulated else R.string.rivo_source_real),
...
fun RivoGrowthSummary(
    ...
    Column(modifier = modifier, verticalArrangement = Arrangement.spacedBy(6.dp)) {
        Text(stringResource(R.string.rivo_growth_stage, stage), style = MaterialTheme.typography.labelLarge)
        Text(stringResource(R.string.rivo_total_xp, totalXp), style = MaterialTheme.typography.headlineMedium)
        Text(
            text =
                if (xpUntilNextStage == null) {
                    stringResource(R.string.rivo_growth_final)
                } else {
                    stringResource(R.string.rivo_growth_remaining, xpUntilNextStage)
                },
